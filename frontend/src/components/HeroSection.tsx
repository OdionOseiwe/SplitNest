    ...
    <div className='md:pt-28 pt-30 '>
      <div className='grid grid-cols-1 md:grid-cols-2 max-w-7xl m-auto px-4'>
        <div>
          ...
          <button className='w-full md:w-75 flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600 md:text-xl py-3 md:px-18 space-x-2 px-8 rounded-xl text-white hover:shadow-2xl hover:scale-105 transition duration-300 hover:cursor-pointer'><span className='pr-2'>Get Started </span><ArrowRight /></button>
        </div>
        <div className='pt-5'>
          <AnimatedHeroSlider/>
        </div>
